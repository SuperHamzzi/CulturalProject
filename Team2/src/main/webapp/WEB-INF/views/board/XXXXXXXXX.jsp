    ...
    <div class="board-container">
      <div class="board-list">
        <ul>
          ...
          <li><a href="board-best.html">베스트게시판</a></li>
          <li><a href="board-free.html">자유게시판</a></li>
          <li><a href="board-question.html">질문게시판</a></li>
          <li><a href="board-customer.html">고객센터</a></li>
        </ul>
      </div>
      <!-- 게시판 메인 -->
      ...
      <!-- 게시판 -->
        <table class="board-table">
          ...
          <tr class="board-content">
            ...
            <td class="td-ttl "><a href="boaed-detail.html">공지사항 게시판입니다</a> <span class="new-txt">new</span></td>
        ...
        <div class="create-board"><span><a href="/boaed-write.html">작성하기</a></span></div>
