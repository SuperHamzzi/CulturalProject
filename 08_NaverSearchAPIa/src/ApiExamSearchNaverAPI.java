...
public class ApiExamSearchNaverAPI {
    ...
    public static void main(String[] args) {
        String clientId = "dGF_t3GxnI6rx6lx4JiS"; //애플리케이션 클라이언트 아이디
        String clientSecret = "fgmO_JwP5p"; //애플리케이션 클라이언트 시크릿

        String apiURL = "https://openapi.naver.com/v1/search/news.json";    // 뉴스 JSON 결과
        String query = "코로나"; // 검색어
        String display = "10"; // 보여질 검색 개수, 최대 100개
        String start ="1"; //검색 시작 위치
        try {
            query = URLEncoder.encode(query, "UTF-8"); // 검색어 들어가는 부분
