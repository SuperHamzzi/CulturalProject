...
<body>
  ...
  <main class="page-wrapper">
    <header class="navbar navbar-expand-lg navbar-light bg-light d-flex flex-column p-0" data-scroll-header>
      ...
      <div class="container header">
        ...
        <h1 class="logo"><a href="index.jsp">나만의 박물관</a></h1>
        ...
        <div class="collapse navbar-collapse order-lg-2" id="navbarNav">
          <ul class="navbar-nav navbar-nav-scroll" style="max-height: 35rem; margin: 0 auto;">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link" href="#">문화재</a>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">컬렉션</a>
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="#">Grid with Filters</a></li>
                <li><a class="dropdown-item" href="#">Single Place - Gallery</a></li>
                <li><a class="dropdown-item" href="#">Single Place - Info</a></li>
                <li><a class="dropdown-item" href="#">Single Place - Reviews</a></li>
              </ul>
            </li>
            <li class="nav-item dropdown">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">베스트게시판</a></li>
                <li><a class="dropdown-item" href="#">자유게시판</a></li>
                <li><a class="dropdown-item" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">질문게시판</a></li>
        ...
        <div class="mb-md-5">
          <div class="tns-carousel-wrapper">
            <div class="tns-carousel-inner " data-carousel-options='{"gutter": 16, "autoplay": true, "autoplayTimeout":3000}'>
              <div class="main-slide" style="background-image: url(${path}/resources/img/card-11.svg);">
                <div class="slide-item d-flex flex-row justify-content-between col-xl-8 col-lg-8 col-md-10 mx-auto mb-sm-0 mb-5 px-0 ">
                  <div class="text-area">
                    ...
                    <a class="btn btn-primary btn-sm rounded-pill order-lg-3" href="#">컬렉션 구경하기</a>
                  </div>
                  <div class="card-area">
              ...
              <div class="main-slide" style="background-image: url(${path}/resources/img/행사1.jpg);">
                <div class="slide-item col-xl-8 col-lg-8 col-md-10 mx-auto mb-sm-5 mb-4 px-0" style="text-align: right;">
                  ...
                  <a class="btn btn-primary btn-sm rounded-pill order-lg-3" href="#">행사 더 보러가기</a>
                </div>
              </div>
        ...
        <div class="tns-carousel-inner row gx-4 mx-0 pt-3 pb-4" data-carousel-options="{&quot;items&quot;: 4, &quot;responsive&quot;: {&quot;0&quot;:{&quot;items&quot;:1},&quot;500&quot;:{&quot;items&quot;:2},&quot;768&quot;:{&quot;items&quot;:3},&quot;992&quot;:{&quot;items&quot;:5}}}">
          ...
          <div class="col">
            <div class="card shadow-sm card-hover border-0">
              ...
              <div class="card-body position-relative pb-3">
                ...
                <h3 class="h6 mb-2 fs-base"><a class="nav-link stretched-link" href="#">문화재 이름1</a></h3>
              </div>
            </div>
          </div>
          <!-- Item -->
          <div class="col">
            <div class="card shadow-sm card-hover border-0">
              ...
              <div class="card-body position-relative pb-3">
                <div class="mb-2"><span class="d-table badge bg-success">국보</span></div>
                <h3 class="h6 mb-2 fs-base"><a class="nav-link stretched-link" href="#">문화재 이름2</a></h3>
              </div>
            </div>
          </div>
          <!-- Item -->
          <div class="col">
            <div class="card shadow-sm card-hover border-0">
              ...
              <div class="card-body position-relative pb-3">
                <div class="mb-2"><span class="d-table badge bg-success">국보</span></div>
                <h3 class="h6 mb-2 fs-base"><a class="nav-link stretched-link" href="#">문화재 이름3</a></h3>
              </div>
            </div>
          </div>
          <!-- Item -->
          <div class="col">
            <div class="card shadow-sm card-hover border-0">
              ...
              <div class="card-body position-relative pb-3">
                <div class="mb-2"><span class="d-table badge bg-success">국보</span></div>
                <h3 class="h6 mb-2 fs-base"><a class="nav-link stretched-link" href="#">문화재 이름4</a></h3>
              </div>
            </div>
          </div>
          <!-- Item -->
          <div class="col">
            <div class="card shadow-sm card-hover border-0">
              ...
              <div class="card-body position-relative pb-3">
                <div class="mb-2"><span class="d-table badge bg-success">국보</span></div>
                <h3 class="h6 mb-2 fs-base"><a class="nav-link stretched-link" href="#">문화재 이름5</a></h3>
              </div>
            </div>
          </div>
          <!-- Item -->
          <div class="col">
            <div class="card shadow-sm card-hover border-0">
              ...
              <div class="card-body position-relative pb-3">
                <div class="mb-2"><span class="d-table badge bg-success">국보</span></div>
                <h3 class="h6 mb-2 fs-base"><a class="nav-link stretched-link" href="#">문화재 이름6</a></h3>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="container mb-5 pb-lg-3">
      <div class="d-flex flex-column align-items-start justify-content-between mb-3">
        ...
        <div class="w-100 d-flex align-items-center justify-content-between">
          ...
          <a class="event more btn btn-link ms-md-3 ms-auto p-0 fw-bold" href="#">더 보러가기<i class="fi-arrow-long-right ms-2"></i></a>
        </div>
      </div>
      <!-- Carousel-->
            ...
            <div class="card border-0 bg-size-cover pt-5" style="background-image: url(${path}/resources/img/행사1.jpg);">
              ...
              <div class="card-body text-center text-md-start pt-4 pt-xl-0">
                <div class="d-md-flex justify-content-between align-items-end">
                  ...
                  <div class="btn-group">
                    <a class="ticket btn btn-primary rounded-pill px-5" href="#">예매하기</a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="bottom-ss">
        ...
        <section class="community">
          ...
          <div class="d-md-flex align-items-center justify-content-between mb-2 pb-md-2">
            ...
            <div class="w-100 ms-md-3 mb-n3 pt-2 pb-3 px-1" data-simplebar data-simplebar-auto-hide="false">
              <div class="d-flex align-items-start flex-row-reverse">
                <a class="more btn btn-link ms-md-3 ms-auto p-0 fw-bold" href="#">더 보러가기
          ...
          <table class="main_community_title">
            <tr>
              <td onClick="location.href='#'">[미술]북한사찰들은 안료나 단청양식에서 세세하게... </td>
            </tr>
            <tr>
              <td onClick="location.href='#'">1960년대 도정궁 모습</td>
            </tr>
            <tr>
              <td onClick="location.href='#'">실제 신라 유물로 두는 바둑</td>
            </tr>
            <tr>
              <td onClick="location.href='#'">태종 이방원 세트 건축에 대한 생각</td>
            </tr>
            <tr>
              <td onClick="location.href='#'">[미술사]꼭 봐야 할 이건희 특별전. 어느 수집가의...</td>
            </tr>
            <tr>
              <td onClick="location.href='#'">서원 철폐령 당시에 6개 남기고 다 철폐하였다 하...</td>
            </tr>
            <tr>
              <td onClick="location.href='#'">국외소재문화재 현황 및 환수가치에 관한 설문조사...</td>
            </tr>
          </table>
        </section>
      </div>
  ...
  <!-- Back to top button-->
  <a class="btn-scroll-top" href="#" data-scroll><span class="btn-scroll-top-tooltip text-muted fs-sm me-2">Top</span><i class="btn-scroll-top-icon fi-chevron-up"></i></a>
