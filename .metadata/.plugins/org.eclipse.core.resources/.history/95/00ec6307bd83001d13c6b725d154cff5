...
<head>
    ...
    <link rel="stylesheet" media="screen" href="${path}/resources/css/sign_in.css">
...
<body>
    <div class="page">
        ...
        <form id="loginFrm" action="${path}/login" method="">
            <div class="text_id">
                <h1>아이디</h1>
            </div>
            <input type="text" name="userId" id="userId" class="text_field" required="required">


            <div class="text_pw">
                <h1>비밀번호</h1>
            </div>
            <input type="password" name="userPwd" id="userPwd" class="text_field" required="required">
        ...
        <ul class="links">
            <li>
                <h1><a href="find_id.html">아이디 찾기 </a></h1>
            </li>
            <li>
                <h1><a href="find_pw.html">비밀번호 찾기 </a> </h1>
            </li>
            <li>
                <h1><a href="sign_up.html">회원가입</a></h1>
            </li>
        </ul>
        ...
        <a href="javascript:kakaoLogin();">
            <div class="kakao_btn">
                <img src="${path}/resources/img/login_image/kakao_logo.png" class="logo_icon">
                <h1> 카카오 로그인</h1>
            </div>
        </a>
        <script src="https://developers.kakao.com/sdk/${path}/resources/js/kakao.js"></script>
        <script>
        ...
        <a id="naverIdLogin_loginButton" href="javascript:void(0)">
            <div class="naver_btn">
                <img src="${path}/resources/img/login_image/naver_logo.png" class="logo_icon">
                <h1>네이버 로그인</h1>
            </div>
        </a>
        <!-- 네이버 스크립트 -->
        <script src="https://static.nid.naver.com/${path}/resources/js/naveridlogin_js_sdk_2.0.2.js" charset="utf-8"></script>
        <script>
        ...
        <a href="">
            <div class="google_btn">
                <img src="${path}/resources/img/login_image/google_logo.png" class="logo_icon">
                <h1>구글 로그인</h1>
            </div>
        </a>
